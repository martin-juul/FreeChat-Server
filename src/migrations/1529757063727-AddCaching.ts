...
export class AddCaching1529757063727 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TYPE "chat_room_permission_role_enum_old" AS ENUM('MUTE', 'KICK', 'BAN', 'CHANGE_COLOR', 'JOIN', '0', '1', '2', '3', '4')`);
